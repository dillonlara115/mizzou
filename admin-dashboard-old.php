		...
		<div class="st-content"><!-- this is the wrapper for the content -->
			<div class="st-content-inner"><!-- extra div for emulating position:fixed of the menu -->
				...
				<div id="general-profile" style="min-height: initial; margin-left: 150px;">
					...
					<?php } ?>
					<div id="name-display">
						<h4><?php echo $_SESSION['admin_first_name'] . ' ' . $last_name;?></h4>
				...
				<div style="max-width: 960px; margin: 0 auto;">
					<form action="admin-dashboard.php" method="POST">
						...
						<div class="account-information">
							...
							<button type="button" id="account-edit">Edit Account Information</button>
							<button type="button" id="cancel-account-edit">Cancel</button>
