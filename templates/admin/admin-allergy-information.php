    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form class='admin-form' action="admin-dashboard.php" method="POST">
			...
			<div class="form-group">
				<label for="medicine_allergies">Are you allergic to any medications?</label>
				<textarea rows="4" class="form-control" name="medicine_allergies" placeholder="<?php echo $allergic_medication; ?>"></textarea>
			</div>
			<div class="form-group">
				<label for="current_medications" >List any medications you are taking:</label>
				<textarea rows="4" class="form-control" name="current_medications" placeholder="<?php echo $current_medication; ?>"></textarea>
			</div>
			<div class="form-group">
				<label for="health_issues" >Do you have any health issues? If so, please indicate:</label>
